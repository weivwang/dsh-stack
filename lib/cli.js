...
async function runCli(argv = process.argv) {
	const program = new Command().name("dsh-stack").description("Reproducible DeepSeek Harness environments in one portable, secret-safe Stackfile").version("0.1.0").showSuggestionAfterError();
